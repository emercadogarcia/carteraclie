CREATE OR REPLACE FORCE VIEW DETALLE_CARTERA_RESUM(REG, NOMBRE_CADENA, CANAL_VENTA, RPN_COBRANZA, CODIGO_CLIENTE, NOMBRE, FECHA_FACTURA, FECHA_VENCIMIENTO, DOCUMENTO, CONCEPTO, MONTO_ORIGINAL, COBROS_PREVIOS, NDC_APLICADAS, SALDO, FECHA_ASIENTO) AS
SELECT 
DISTINCT 
...
DT.CODIGO_CLIENTE, C.NOMBRE,DT.FECHA_FACTURA, DT.FECHA_VENCIMIENTO, DT.DOCUMENTO, DT.CONCEPTO, DT.MONTO_ORIGINAL, DT.COBROS_PREVIOS, DT.NDC_APLICADAS, DT.SALDO, DT.FECHA_ASIENTO
FROM DETALLE_CARTERA_PROM DT, CLIENTES C, (
